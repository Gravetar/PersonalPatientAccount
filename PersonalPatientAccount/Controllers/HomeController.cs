...
namespace PersonalPatientAccount.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        /// </summary>
        /// <returns>OK если не существует BadReqwst если существует</returns>
        ...
        /// <returns>Лист записей в амбулаторной карте пациента</returns>
        [HttpGet("GetRecords")]
        ...
        /// </summary>
        /// <param name="id">id пациента</param>
        /// <returns>Лист записей на прием к врачу у пациента</returns>
        ...
        /// </summary>
        /// <returns>Объект социальной информации</returns>
        ...
        /// </summary>
        /// <returns>Все специальности врачей</returns>
        ...
        /// </summary>
        /// <returns>Лист докторов по названию специальности</returns>
        ...
        /// </summary>
        /// <returns>Лист свободного времени</returns>
        ...
        /// <returns>Статус запроса на изменение пользователя</returns>
        ...
        /// </summary>
        /// <param name="model">Регистрируемый пользователь</param>
        /// <returns>Статус запроса на регистрацию пользователя</returns>
        [HttpPost]
        [Route("Register")]
        [AllowAnonymous]
        ...
        /// </summary>
        /// <param name="appointment">Параметры записи</param>
        /// <returns>Статус запроса на добавление новой записи к врачу</returns>
        ...
        /// </summary>
        /// <returns>OK-при удачной загрузке FAIL-при ошибки загрузки</returns>
        ...
        /// </summary>
        /// <param name="id">id пациента</param>
        /// <returns>Удаленная запись к врачу</returns>
        ...
        /// <returns>Claim пользователя</returns>
        ...
        /// <summary>
        /// Возвращает айди текущего пользователя
        /// </summary>
        /// <returns></returns>
